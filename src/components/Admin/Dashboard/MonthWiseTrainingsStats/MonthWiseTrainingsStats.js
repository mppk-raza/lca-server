    ...
    axios
      .post(
        process.env.REACT_APP_BACKEND_URL +
          "/api/adminDashboard/getTrainingCountsByMonth",
        {
  ...
  return (
    <Card>
      <CardHeader
        ...
        //   </Button>
        // )}
        title="Trainings against Time (Monthly Count)"
      />
      <Divider />
      <CardContent>
        <Box
...
export default MonthWiseTrainingsStats;
